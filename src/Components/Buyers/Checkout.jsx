      ...
      <div className="flex flex-col space-y-3">
        ...
        <div className="flex flex-col md:flex-row md:space-x-4 md:space-y-0 space-y-3">
          ...
          <div className="w-full md:w-1/3 bg-white p-3 rounded-lg shadow-sm">
            ...
            {/* <div className="flex items-center justify-between mt-4">
              <span className="text-sm text-gray-600">Available balance: SAR 430.00</span>
              <input type="checkbox" checked={useCash} onChange={() => setUseCash(!useCash)} className="w-5 h-5" />
            </div> */}
            {/* <p className="text-xs text-gray-500 mt-1">Use cash to pay for the remaining amount of this purchase.</p>
            <div className="flex items-center justify-between mt-2">
              <span className="text-sm text-gray-600">Make it a gift</span>
              <input type="checkbox" checked={makeGift} onChange={() => setMakeGift(!makeGift)} className="w-5 h-5" />
            </div> */}
            {/* <p className="text-xs text-gray-500 mt-1">Wrap the items for SAR 20. All will be wrapped in one box (max 10 items).</p> */}
          </div>
        ...
        <div className="flex flex-col md:flex-row md:space-x-4 md:space-y-0 space-y-3">
          ...
          <div className="w-full md:w-1/3 md:ml-auto bg-white p-4 rounded-lg shadow-sm">
            ...
            <button className="w-full bg-blue-100 text-blue-600 py-2 rounded-lg hover:bg-blue-200 cursor-pointer">Checkout</button>
          </div>
        </div>
      </div>
    </div>
